...
<script type="text/html" id="tmp">
	{{#  if(d.number < d.min_num){ }}
		<span class="layui-badge">库存不足</span>
	{{#  } else { }}
		{{ '' }}
	{{#  } }}
</script>
